...
def test_normalize_image_name_with_simple_name():
...
def test_normalize_image_name_with_tag():
...
def test_normalize_image_name_with_digest():
...
def test_normalize_image_name_with_registry():
...
def test_normalize_image_name_with_namespace():
...
def test_normalize_image_name_full():
...
def test_collect_images_complex_pattern():
...
def test_prepare_chart_with_directory():
...
def test_prepare_chart_with_archive():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        mock_path.__str__.return_value = str(chart_path)
...
def test_extract_images_command():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        with mock.patch("cli_onprem.commands.helm.prepare_chart") as mock_prepare:
            ...
            with mock.patch("cli_onprem.commands.helm.helm_dependency_update") as mock_dep:
                with mock.patch("cli_onprem.commands.helm.helm_template") as mock_template:
                    ...
                    with mock.patch("cli_onprem.commands.helm.collect_images") as mock_collect:
